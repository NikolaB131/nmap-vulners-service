...
const (
	NetVulnService_CheckVuln_FullMethodName = "/NetVulnService/CheckVuln"
)
...
func (c *netVulnServiceClient) CheckVuln(ctx context.Context, in *CheckVulnRequest, opts ...grpc.CallOption) (*CheckVulnResponse, error) {
	...
	err := c.cc.Invoke(ctx, NetVulnService_CheckVuln_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var NetVulnService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/proto/nmap-vulners-service.proto",
}
